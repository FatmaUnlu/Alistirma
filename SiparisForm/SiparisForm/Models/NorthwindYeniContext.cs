...
{
    public partial class NorthwindYeniContext : DbContext
    {
        public NorthwindYeniContext()
        {
        }

        public NorthwindYeniContext(DbContextOptions<NorthwindYeniContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<VwUrunsİparİ> VwUrunsİparİs { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-DJ26S8P\\SQLEXPRESS;Initial Catalog=NorthwindYeni;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VwUrunsİparİ>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_URUNSİPARİS");
